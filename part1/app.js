...
app.get('/api/walkrequests/open', async (req, res) => {
    try {
        const [walkRequests] = await db.execute("SELECT wr.request_id, d.name AS  FROM WalkRequests wr JOIN Dogs d ON wr.dog_id = d.dog_id JOIN Users u ON d.owner_id = u.user_id")
    } catch (err) {
